...
this.allImages.length,d=0;d<c;d++){var b=this.allImages[d];if(15<b.width&&15<b.height){var a=b.width,e=b.height,h=b.className,f=g.createElement("div");f.className=h;f.style.width=a+"px";f.style.height=e+"px";f.style.overflow="hidden";a=g.createElement("img");a.src="http://www.heyben.com/horse_ebookmarklet/img/horse_ebookmarklet.jpg";a.style.width="100%";a.style.height="auto";b.parentNode.replaceChild(f,b);f.appendChild(a)}}},checkLength:function(c){136<c&&(c=136);return function(d){return d.length>=
